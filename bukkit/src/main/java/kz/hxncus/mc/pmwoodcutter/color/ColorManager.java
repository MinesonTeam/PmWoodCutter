package kz.hxncus.mc.pmwoodcutter.color;

import com.google.common.collect.ImmutableMap;
import kz.hxncus.mc.pmwoodcutter.PmWoodCutter;
import kz.hxncus.mc.pmwoodcutter.color.caching.LruCache;
import kz.hxncus.mc.pmwoodcutter.color.pattern.GradientPattern;
import kz.hxncus.mc.pmwoodcutter.color.pattern.Pattern;
import kz.hxncus.mc.pmwoodcutter.color.pattern.RainbowPattern;
import kz.hxncus.mc.pmwoodcutter.color.pattern.SolidPattern;
import kz.hxncus.mc.pmwoodcutter.util.ReflectionUtil;
...
public class ColorManager {
    ...
    public ColorManager(PmWoodCutter plugin) {
